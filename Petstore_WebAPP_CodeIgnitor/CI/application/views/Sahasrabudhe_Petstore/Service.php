<?
   ...
   if(($fdbfire AND $ldbfire AND $edbfire AND $phdbfire AND $Bname)==1)
        { 
                    ...
                    $sql="INSERT INTO service_data(b_id,fname,lname,phone,email,userid,bname) Values('$value','$fname','$lname',
                    '$phoneno','$email ','Petstr_$uniqid','$Bname')";  
                    $sql1="INSERT INTO services(service_id,b_id) VALUES ($Sid,$value)";
                    $sql2="INSERT INTO user_data(userid,password,email,roleid) Values('Petstr_$uniqid','wdm@$pwd','$email','2')";
