...
$link = mysqli_connect("localhost", "root", "", "test");
    ...
    if(isset($New_Pwd) AND $Old_Pwd )
    {
       ...
       /* echo"$User_ID";
        echo "this is $Old_Pwd";
        echo "this is $New_Pwd";*/
        
       $sql="SELECT password  FROM user_data WHERE userid='$User_ID'";  
                ...
                else if(isset($db_pwd))
                {
                    ...
                    $sql="UPDATE user_data SET  password = '$New_Pwd' WHERE userid='$User_ID'";
                    $result = $link->query($sql);
                    if ($result->num_rows > 0)
                 {
                // output data of each row
    ...
    <div id="pagecontent">
        ...
        <table>
               <form method ="POST">
                ...
                <td><input type="password" name="pwdold"  placeholder="Old Password" value="<?php echo isset ($_POST["pwdold"])? $_POST["pwdold"] : '';?>"><text id="error"><?php if(isset($pwderror)) echo$pwderror;?></text></td>
                </tr>
                <tr>
                <td>Enter New Password*:</td>
                <td><input type="password" name="pwdnew"  placeholder="New Password" value="<?php echo isset ($_POST["pwdnew"])? $_POST["pwdnew"] : '';?>"><text id="error"><?php if(isset($pwderror)) echo$pwderror;?></text></td>
                </tr>      
                </tbody>
